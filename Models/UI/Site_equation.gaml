...
//	loop position over: fishing_site
//	{
//		write(position);
//		
//	}
...
//	}
		...
		ask sites where ([each.grid_x, each.grid_y] in fishing_site)
		{
			E <- fish_reproduce_rate*4;
		}
	}
