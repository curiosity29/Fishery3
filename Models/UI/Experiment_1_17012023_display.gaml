...
//	int cycle_min <- cycle_max/2;
	...
	reflex cal
	{
		...
		mean <- mean(dens_list) - 1;
		dN_cut <- nb_fish* (mean - (var + mean^2) / k);
		dens_list <- [];
		
//		delta <- 1 - 4*nb_fish^2/fish_local_cap^2 *var;
//		root1 <- 1/2 * K*(1+sqrt(delta));
		// r*
//		dN_expected <- r / p * sum()/ length(dens_list);
...
//				data "fish population anual changes" value: nb_fish color: #green;
//				data "old capacity" value: K color: #blue;
//				data "new capacity" value: root1 color: #red;
//				data "new capacity" value: var*100 color: #black;
//				data "b" value: 1 color: #blue;



//				data "population" value: nb_fish color: #blue;
//				data "new capacity" value: newK color: #red;
//				data "old capacity" value: K color: #green;
...
//				data "1" value: 1 color: #black;
				...
				data "moving average" value: var_moving_average color: #black;
